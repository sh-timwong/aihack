...
# No longer loading from .env, assuming Application Default Credentials
# load_dotenv()
    ...
    try:
        while True:
            ...
            if mime_type == "text/plain":
                ...
                print(f"[CLIENT TO AGENT]: 123{data}")
                ...
                print(f"[CLIENT TO AGENT]: audio/pcm: 123{len(decoded_data)} bytes")
